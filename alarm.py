...
frame_body=Frame(window, width=400, height=400, bg=co2)
frame_body.grid(row=1,column=0)

# configuring frame body
img = Image.open('iconn.png')
img.resize((100,100))
...
hour= Label(frame_body, text = "hours", height=1, font=('Ivy 7 bold'),bg=bg_color,fg=co1)
...
min= Label(frame_body, text = "minutes", height=1, font=('Ivy 7 bold'),bg=bg_color,fg=co1)
...
sec= Label(frame_body, text = "seconds", height=1, font=('Ivy 7 bold'),bg=bg_color,fg=co1)
...
period= Label(frame_body, text = "period", height=1, font=('Ivy 7 bold'),bg=bg_color,fg=co1)
